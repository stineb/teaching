...
df3 %>% 
  ...
  xlim(0,1) + ylim(0,1) +
  labs(x = "dI/I", y = "dC*/C*")
ggsave("~/teaching/gcb/dln.pdf", width = 4, height = 3.5)
...
df3 %>% 
  ...
  xlim(0,1) + ylim(0,1) +
  labs(x = "dI/I", y = "dC*/C*")
ggsave("~/teaching/gcb/dln_2turnover.pdf", width = 5, height = 3.5)
...
animate(gganim, nframes = 100, width = 700, height = 500, fps = 10, renderer = gifski_renderer("~/teaching/gcb/gganim_1box_step_2turnover.gif", loop = TRUE))
```
...
df3 %>% 
  ...
  xlim(0,1) + ylim(0,1) +
  labs(x = "dI/I", y = "dC*/C*")
ggsave("~/teaching/gcb/dln_nonlin_turnover.pdf", width = 5, height = 3.5)
```
...
df3 %>% 
  ...
  xlim(0,1) + ylim(0,1) +
  labs(x = "dI/I", y = "dC*/C*")
ggsave("~/teaching/gcb/dln_cpool1.pdf", width = 3, height = 2)
...
df4 %>% 
  ...
  xlim(0,1) + ylim(0,1) +
  labs(x = "dI/I", y = "dC*/C*")
ggsave("~/teaching/gcb/dln_cpool2.pdf", width = 3, height = 2)
...
animate(gganim, nframes = 100, width = 700, height = 500, fps = 10, renderer = gifski_renderer("~/teaching/gcb/gganim_1box_step_2pools.gif", loop = TRUE))
...
animate(gganim, nframes = 100, width = 700, height = 500, fps = 10, renderer = gifski_renderer("~/teaching/gcb/gganim_1box_step_tot.gif", loop = TRUE))
```
...
animate(gganim, nframes = 100, width = 700, height = 500, fps = 10, renderer = gifski_renderer("~/teaching/gcb/gganim_1box_step_2pools_allocation.gif", loop = TRUE))
```
...
df3 %>% 
  ...
  xlim(0,1) + ylim(0,1) +
  labs(x = "dI/I", y = "dC*/C*")
ggsave("~/teaching/gcb/dln_cpool_nonlinalloc.pdf", width = 3, height = 2)
```
...
ggsave("~/teaching/gcb/cropland_diff_diff_1970_2017.pdf", width = 8, height = 4)
...
gg
ggsave("~/teaching/gcb/map_lair.pdf", width = 8, height = 4)
```
...
ggsave("~/teaching/gcb/assimilation.pdf", width = 5, height = 3)
```
